...
public class strassen_matrix
{
	public static void main(String [] args)
	{
		...
		//compute the elapsed time 
                ...
                System.out.println("Time taken for 16 length array multiplication: " + elapsed_time + " milliseconds");
		...
		//part 1(d)
                ...
                end_time = System.currentTimeMillis();
                elapsed_time = end_time - start_time;
                System.out.println("Time taken for 64 length array multiplication: " + elapsed_time + " milliseconds");

                //part 1(e)
                //compute elapsed time for the multiplication of A and B with square_matrix_multiply
                start_time = System.nanoTime();
                square_matrix_multiply(A_2, B_2, C_2);
                end_time = System.nanoTime();
                elapsed_time = end_time - start_time;
                System.out.println("Time taken for 16 length array multiplication with square_matrix_multiply:\n" +
                + elapsed_time + " nanoseconds");

                //part 1(f)
                //compute elapsed time for the multiplication of A and B with square_matrix_multiply with A_3 and B_3
                start_time = System.nanoTime();
                square_matrix_multiply(A_3, B_3, C_3);
                end_time = System.nanoTime();
                elapsed_time = end_time - start_time;
                System.out.println("Time taken for 64 length array multiplication with square_matrix_multiply:\n" +
                + elapsed_time + " nanoseconds");
        }
	...
	public static void strassen_matrix_multiply(int [][] A, int [][] B, int [][] C)
	{
		...
		for (int i = 0; i < n_half; i++)
		{
			for (int j = 0; j < n_half; j++)
			{
				...
				S1[i][j] = B[B12_row_index_start+i][B12_col_index_start+j]-B[B22_row_index_start+i][B22_col_index_start+j];
		                ...
		                //*****************************************
				//Implement computation of S2, S3, S4, S5, S6, S7, S8, S9,S10 of the strassen's algorithm
                                //*****************************************
		...
		//Implement computation of P2 to P7 here
                //*****************************************
                //Implement computation of P2, P3, P4, P5, P6, P7 of the strassen's algorithm
                //*****************************************
                ...
                // copy_submatrix(B, B12_row_index_start, B12_col_index_start, temp);
                strassen_matrix_multiply(S7, S8, P6);
                // copy_submatrix(A, A21_row_index_start, A21_col_index_start, temp);
