...
public class matrix
{
	public static void main(String [] args)
	{
		...
		//multiply A and B and print the result on screen
                ...
                System.out.println(" Part 1(b) = > A * B = "+ Arrays.deepToString(C));
               // I tested for A  1  3 and B  6   8
                //                7  5        4   2
		...
		//compute the elapsed time 
                ...
                System.out.println(" Part 1(c) = 16 lenght array = > " + elapsed_time );
             // I used strassen and 64 lenght array
		...
		//part 1(d)
                ...
                end_time = System.nanoTime();
                elapsed_time = end_time - start_time;
                System.out.println(" Part 1(d) = 64 lenght array = > " + elapsed_time );
                // I used strassen and 64 lenght array
                // part 1(e)
                start_time = System.nanoTime();
                ...
                end_time = System.nanoTime();
                elapsed_time = end_time - start_time;
                System.out.println(" Part 1(e) = 16 lenght array with square_matrix_multiply = >" +
                + elapsed_time );
             // I used square matrix multiply and 16 lenght array
                // part 1(f)
                start_time = System.nanoTime();
                square_matrix_multiply(A_3, B_3, C_3);
                end_time = System.nanoTime();
                elapsed_time = end_time - start_time;
                System.out.println(" Part 1(f) = 64 lenght array with square_matrix_multiply = >" +
                + elapsed_time);
             // I used square matrix multiply and 64 lenght array
	...
	public static void strassen_matrix_multiply(int [][] A, int [][] B, int [][] C)
	{
		...
		for (int i = 0; i < n_half; i++)
		{
			for (int j = 0; j < n_half; j++)
			{
                ...
                // I implemented computation of S2, S3, S4, S5, S6, S7, S8, S9, S10 
		...
		//Implement computation of P2,...,P7 here
          ...
          strassen_matrix_multiply(S9, S10, P7);
           // I implemented computation of P2, P3, P4, P5, P6, P7
				...
				//Implement computation of C12, C21, and C22 here
                  ...
                  C[C22_row_index_start+i][C22_col_index_start+j] = P5[i][j] + P1[i][j] -P3[i][j]-P7[i][j];
                   // I implemented computation of C12, C21 and C22
